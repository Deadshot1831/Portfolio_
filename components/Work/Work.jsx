...
const PROJECTS = [
  {
    ...
    role: "Design & Build",
    blurb:
      "A realtime 3D product configurator — material swaps, lighting presets and a buttery 60fps camera, all in the browser.",
  ...
  },
  {
    ...
    role: "Frontend Lead",
    blurb:
      "A motion-first analytics dashboard where every transition carries meaning — data that animates into understanding.",
    tags: ["Next.js", "GSAP", "D3"],
    href: "#",
    hue: "var(--blue)",
    hue2: "#7c5cff",
  },
  {
    ...
    role: "Engineering",
    blurb:
      "An editorial publishing platform built for typography — fluid type, art-directed layouts, sub-second loads.",
  ...
  },
  {
    ...
    role: "Creative Dev",
    blurb:
      "A generative art gallery rendering thousands of GLSL-driven pieces, each one seeded and shareable.",
